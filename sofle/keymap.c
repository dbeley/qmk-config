...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_EQL,  KC_MINS, KC_PLUS, KC_LCBR, KC_RCBR, _______,  _______, KC_LBRC, KC_RBRC, KC_SCLN, KC_COLN, KC_BSLS, _______, \
                    KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT, _______,  _______, KC_MUTE, KC_MPRV, KC_MPLY, KC_MNXT\
),
[_RAISE] = LAYOUT( \
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                      KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,\
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                       KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_F12, \
...
[_ADJUST] = LAYOUT( \
  ...
  XXXXXXX,XXXXXXX,XXXXXXX,KC_VOLD,KC_MUTE,KC_VOLU,                     KC_PGUP, KC_DEL, KC_UP, KC_BSPC,KC_HOME,XXXXXXX, \
  KC_VOLD,KC_MUTE,KC_VOLU,KC_MPRV,KC_MPLY,KC_MNXT,                     KC_PGDN,KC_LEFT,KC_DOWN,KC_RGHT, KC_END,XXXXXXX, \
  KC_MPRV,KC_MPLY,KC_MNXT,XXXXXXX,KC_BSPC,KC_ENT,XXXXXXX,      XXXXXXX,KC_ENT,KC_BSPC,XXXXXXX,XXXXXXX,XXXXXXX,XXXXXXX, \
 ...
 * | `    |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  | Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | LGUI |   Q  |   W  |   F  |   P  |   G  |                    |   J  |   L  |   U  |   Y  |   ;  |  '   |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | LCTR |   A  |   R  |   S  |   T  |   D  |-------.    ,-------|   H  |   N  |   E  |   I  |   O  | Enter|
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
...
[_COLEMAK] = LAYOUT( \
  KC_GRV,   KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,  KC_BSPC, \
  LGUI_T(KC_TAB),   KC_Q,   KC_W,    KC_F,    KC_P,    KC_G,                      KC_J,    KC_L,    KC_U,    KC_Y, KC_SCLN,  KC_QUOT, \
  LCTL_T(KC_ESC),   KC_A,   KC_R,    KC_S,    KC_T,    KC_D,                      KC_H,    KC_N,    KC_E,    KC_I,    KC_O,  KC_ENT, \
  LSFT_T(KC_ESC),  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,      XXXXXXX,KC_K,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  RSFT_T(KC_ESC), \
                 KC_LGUI, KC_LALT, KC_LCTRL, KC_SPC, KC_LOWER,    KC_RAISE, KC_SPC, KC_RCTRL, KC_RALT, KC_RGUI \
)
/* RAISE
 * ,----------------------------------------.                    ,-----------------------------------------.
